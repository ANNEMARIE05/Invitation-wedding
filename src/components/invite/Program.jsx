...
export default function Program() {
  return (
    <section id="programme" className="relative overflow-hidden py-24 md:py-36 px-5 sm:px-8 lg:px-16 bg-[#F3ECE2]" data-testid="program-section">
      <Floral src={FLORALS.dahlia} className="absolute -bottom-8 -right-12 z-0 hidden w-56 opacity-75 xl:block" />
